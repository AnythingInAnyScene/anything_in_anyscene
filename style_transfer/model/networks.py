...
from anything_in_anyscene.style_transfer.utils.tools import extract_image_patches, flow_to_image, \
...
class Generator(nn.Module):
    ...
    def forward(self, x, mask, obj):
        ...
        x_stage2, offset_flow = self.fine_generator(x, x_stage1,mask, obj)
...
class CoarseGenerator(nn.Module):
    ...
    def forward(self, x, mask, obj):
        ...
        if self.use_cuda:
            ...
            obj = obj.cuda()
        # 5 x 256 x 256
        # x = self.conv1(torch.cat([x, ones, mask, obj], dim=1))
...
class FineGenerator(nn.Module):
    ...
    def forward(self, xin, x_stage1, mask, obj):
        ...
        if self.use_cuda:
            ...
            obj = obj.cuda()
        # conv branch
        # xnow = torch.cat([x1_inpaint, ones, mask, obj], dim=1)
