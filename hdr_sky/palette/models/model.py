import torch
import tqdm
from anything_in_anyscene.hdr_sky.palette.core.base_model import BaseModel
from anything_in_anyscene.hdr_sky.palette.core.logger import LogTracker
    ...
    def test(self):
        ...
        with torch.no_grad():
            for phase_data in tqdm.tqdm(self.phase_loader):
                ...
                outputs = Util.postprocess(self.output.cpu())
                img = Image.fromarray(outputs[0])
                img = img.resize((128, 32))
                img.save(os.path.join(self.opt["datasets"]["test"]["which_dataset"]["args"]["data_root"], "sky.png"))
